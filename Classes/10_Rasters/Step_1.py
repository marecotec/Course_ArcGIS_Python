...
arcpy.env.workspace = r"C:\Course_ArcGIS_Python\Classes\10_Rasters\Step_1_Data"
...
raster_list = arcpy.ListRasters()
arcpy.gp.ExtractMultiValuesToPoints("Great_Whites.shp", raster_list, "NONE")

inRasterList = [["doqqsdfsdfsdfsdfsdfsdfsd.img", "doqqval"], ["redstd", "focalstd"],
                ["redmin", "focalmin"]]